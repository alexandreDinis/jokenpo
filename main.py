...
path_audio = '/home/dinis/game/jokenpo/audios/'
jogadas = [0,1,2]
...
while cont == "1":
    pygame.mixer.music.load(f"{path_audio}/8bit-music-for-game-68698.mp3")
    ...
    if jogador in jogadas:  
        ...
        print("=-" * 20)
        pygame.mixer.music.load(f"{path_audio}boom-geomorphism-cinematic-trailer-sound-effects-123876.mp3")
        pygame.mixer.music.play()
        ...
        if cpu == 0:
            if jogador == 1:
                pygame.mixer.music.load(f"{path_audio}epic-hybrid-logo-157092.mp3")
                pygame.mixer.music.play()
    ...
    print("=-" * 20)
    pygame.mixer.music.load(f"{path_audio}Jellica - I tried to write some cutesy platformer kiddy nintendo shit.mp3")
    pygame.mixer.music.play()
